...
<body style="margin:0;padding:0;background-color:${g.bgOuter};font-family:${font};direction:${g.direction};" dir="${g.direction}">

<!-- Preheader spacer -->
<div style="display:none;max-height:0;overflow:hidden;font-size:1px;line-height:1px;color:${g.bgOuter};">&#847;</div>

<center style="width:100%;background-color:${g.bgOuter};">
  <!--[if mso|IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:${g.bgOuter};"><tr><td align="center"><![endif]-->

  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="${g.width}" align="center" class="email-wrap" style="width:${g.width}px;max-width:${g.width}px;background-color:${g.bgInner};">

    <!-- HEADER -->
    <tr>
      <td style="padding:${h.paddingTop}px ${h.paddingRight}px ${h.paddingBottom}px ${h.paddingLeft}px;text-align:${h.align};background-color:${h.bg};">
    ...
    <!-- FOOTER -->
    <tr>
      <td dir="${g.direction}" style="padding:${f.paddingTop}px ${f.paddingRight}px ${f.paddingBottom}px ${f.paddingLeft}px;text-align:center;background-color:${f.bg};color:${f.color};font-size:${f.fontSize}px;font-family:${font};line-height:${f.lineHeight};">
        ${f.text.replace(/\n/g, '<br>')}
      </td>
    </tr>
  ...
  <!--[if mso|IE]></td></tr></table><![endif]-->
    ...
    htmlText(block) {
        ...
        const font = g.direction === 'rtl' ? g.arabicFont : g.font;
        const lh = g.direction === 'rtl' ? g.arabicLineHeight : 1.65;
        const bg = (block.backgroundColor && block.backgroundColor !== 'transparent') ? block.backgroundColor : 'transparent';
        return `<tr>
      <td style="padding:${block.padding}px;font-size:${block.size}px;color:${block.color};text-align:${block.align};line-height:${lh};font-family:${font};background-color:${bg};">
        ${block.content}
      </td>
    </tr>`;
    },
    ...
    htmlTwoTexts(block) {
        ...
        const bgStyle = (block.backgroundColor && block.backgroundColor !== 'transparent') ? `background-color:${block.backgroundColor};` : '';

        return `<tr>
      <td style="padding:16px;${bgStyle}">
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" class="stack">
          <tr>
            <td width="50%" valign="top" class="stack-cell" style="padding-right:${Math.round(gap/2)}px;font-family:${font};font-size:14px;line-height:${lh};color:#334155;text-align:${c0.align};background-color:${c0.backgroundColor && c0.backgroundColor !== 'transparent' ? c0.backgroundColor : 'transparent'};">
              ${c0.content}
            </td>
            <td width="50%" valign="top" class="stack-cell" style="padding-left:${Math.round(gap/2)}px;font-family:${font};font-size:14px;line-height:${lh};color:#334155;text-align:${c1.align};background-color:${c1.backgroundColor && c1.backgroundColor !== 'transparent' ? c1.backgroundColor : 'transparent'};">
              ${c1.content}
            </td>
          </tr>
        </table>
