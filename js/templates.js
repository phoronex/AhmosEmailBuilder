...
const Templates = {
    ...
    'welcome': {
        ...
        header: { enabled: true, textEnabled: true, text: 'Welcome to AHMOS!', align: 'center', textColor: '#ffffff', bg: '#2563eb', paddingTop: 40, paddingBottom: 40, paddingLeft: 30, paddingRight: 30, logo: '' },
        blocks: [
    ...
    'newsletter': {
        ...
        header: { enabled: true, textEnabled: true, text: 'The Monthly Brief', align: 'left', textColor: '#ffffff', bg: '#0f172a', paddingTop: 30, paddingBottom: 30, paddingLeft: 40, paddingRight: 40, logo: '' },
        blocks: [
    ...
    'promo': {
        ...
        header: { enabled: true, textEnabled: true, text: '🔥 LIMITED TIME OFFER', align: 'center', textColor: '#ffffff', bg: '#ea580c', paddingTop: 30, paddingBottom: 30, paddingLeft: 30, paddingRight: 30, logo: '' },
        blocks: [
    ...
    'transactional': {
        ...
        header: { enabled: true, textEnabled: true, text: 'Order Confirmed ✓', align: 'center', textColor: '#ffffff', bg: '#059669', paddingTop: 30, paddingBottom: 30, paddingLeft: 30, paddingRight: 30, logo: '' },
        blocks: [
    ...
    'event': {
        ...
        header: { enabled: true, textEnabled: true, text: "You're Invited!", align: 'center', textColor: '#ffffff', bg: '#4f46e5', paddingTop: 40, paddingBottom: 40, paddingLeft: 30, paddingRight: 30, logo: '' },
        blocks: [
    ...
    'arabic': {
        ...
        header: { enabled: true, textEnabled: true, text: 'أحمس يرحب بكم', align: 'center', textColor: '#ffffff', bg: '#059669', paddingTop: 35, paddingBottom: 35, paddingLeft: 30, paddingRight: 30, logo: '' },
        blocks: [
    ...
    'two-column': {
        ...
        desc: 'Grid layout',
        global: { width: 600, bgOuter: '#f1f5f9', bgInner: '#ffffff', font: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif", direction: 'ltr' },
        header: { enabled: true, textEnabled: true, text: 'Product Updates', align: 'center', textColor: '#ffffff', bg: '#7c3aed', paddingTop: 35, paddingBottom: 35, paddingLeft: 30, paddingRight: 30, logo: '' },
        blocks: [
    ...
    'minimal': {
        ...
        header: { enabled: true, textEnabled: true, text: 'AHMOS', align: 'left', textColor: '#0f172a', bg: '#ffffff', paddingTop: 30, paddingBottom: 10, paddingLeft: 40, paddingRight: 40, logo: '' },
        blocks: [
