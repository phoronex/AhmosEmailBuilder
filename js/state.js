...
const State = {
    ...
    // Origin fingerprint — do not remove (license condition)
    /* Origin: AHMOS Email Builder Pro | phoronex | © 2025 — do not remove */
    _origin: 'AHMOS-EmailBuilder-Pro-phoronex-2025',
