...
const Blocks = {
    ...
    createBlock(type) {
        ...
        switch (type) {
            ...
            case 'image':
                return { ...base, src: 'https://via.placeholder.com/600x300/2563eb/ffffff?text=Sample+Image', alt: 'Sample Image', width: 600, height: 300, lockRatio: true, _nw: 600, _nh: 300, borderRadius: 0, link: '', align: 'center' };
            case 'two-images':
                return { ...base,
                    images: [
                        { src: 'https://via.placeholder.com/280x180/3b82f6/ffffff?text=Image+1', alt: 'Image 1', link: '', width: 280, height: 180, lockRatio: true, _nw: 280, _nh: 180, borderRadius: 0 },
                        { src: 'https://via.placeholder.com/280x180/10b981/ffffff?text=Image+2', alt: 'Image 2', link: '', width: 280, height: 180, lockRatio: true, _nw: 280, _nh: 180, borderRadius: 0 }
                    ], gap: 20, align: 'center'
                };
            case 'two-texts':
                return { ...base,
    ...
    ctrlTwoImages(block, i) {
        const imgPanel = (img, idx) => {
            ...
            <div class="img2-panel">
                ...
                <button type="button" class="clipboard-paste-btn" onclick="Blocks.pasteImageClipboard(${i},${idx})" style="margin-top:5px;font-size:10px;">
                    <i class="fas fa-clipboard"></i> Paste from Clipboard
                </button>
