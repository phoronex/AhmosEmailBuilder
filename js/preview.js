...
<body style="margin:0;padding:0;background-color:${g.bgOuter};font-family:${font};direction:${g.direction};" dir="${g.direction}" bgcolor="${g.bgOuter}">
...
<table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="${g.bgOuter}" style="width:100%;background-color:${g.bgOuter};border-collapse:collapse;">
  <tr>
    <td align="center" valign="top" bgcolor="${g.bgOuter}" style="background-color:${g.bgOuter};padding:20px 0;">
