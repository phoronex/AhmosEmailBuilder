        ...
        if (f.socialEnabled && Array.isArray(f.socialIcons) && f.socialIcons.length > 0) {
            ...
            if (cells) {
                ...
                socialRow =
                    ...
                    '<tr><td align="' + socAln + '" valign="middle"' +
                    ' style="padding:' + socPT + 'px 0 ' + socPB + 'px 0;font-size:0;line-height:0;' +
...
'  </td>\n</tr>';
    ...
    // ─────────────────────────────────────────────────────────────────
    // Social icon library lookup
    // Icons are real PNG base64 data-URIs defined in social_icons.js
    // Two variants: SOCIAL_ICONS_COLORED (default) and SOCIAL_ICONS_WHITE
    //
    // ═══ HOW TO ADD NEW ICONS ═══════════════════════════════════════
    // 1. Open social_icons.js
    // 2. Add entry to SOCIAL_ICONS_COLORED:  myplatform: 'data:image/png;base64,...'
    // 3. Add entry to SOCIAL_ICONS_WHITE:    myplatform: 'data:image/png;base64,...'
    // 4. Add 'myplatform' to the PLATFORMS array in ui.js buildFooterPanel()
    // 5. (Optional) Add a placeholder hint in ui.js soc-url input
    // ════════════════════════════════════════════════════════════════
    _socialIconSrcs(style) {
        const src = (style === 'white')
            ? (typeof SOCIAL_ICONS_WHITE   !== 'undefined' ? SOCIAL_ICONS_WHITE   : {})
            : (typeof SOCIAL_ICONS_COLORED !== 'undefined' ? SOCIAL_ICONS_COLORED : {});
        return src;
    },
...
'  </td>\n</tr>';
    ...
    htmlTextImage(block) {
        ...
        var imgSt = 'display:block;width:' + iw + 'px;max-width:100%;' + hs + 'border:0;' + rr;
        ...
        var imgCellInner = '<table role="presentation" border="0" cellpadding="0" cellspacing="0" align="' + ia + '" style="margin:' + imr + ';"><tr><td align="' + ia + '" style="font-size:0;line-height:0;">' + imgContent + '</td></tr></table>';
...
'    </tr></table>\n    <!--<![endif]-->\n  </td>\n</tr>';
    ...
    htmlTextTwoImages(block) {
        ...
        var makeImg2 = function(img) {
            ...
            var st = 'display:block;width:' + iw + 'px;max-width:100%;' + hs + 'border:0;' + rr;
            ...
            return '<table role="presentation" border="0" cellpadding="0" cellspacing="0" align="' + ia + '" style="margin:' + mg + ';"><tr><td align="' + ia + '" style="font-size:0;line-height:0;">' + inn + '</td></tr></table>';
        };
